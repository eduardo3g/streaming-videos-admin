...
describe('Category Validator', () => {
  describe('create command', () => {
    test('should invalidate an category with malformed name property', () => {
      const arrange = [];
    ...
    it("should invalidate an category with malformed description property", () => {
      expect(() =>
    ...
    it("should invalidate an category with malformed is_active property", () => {
      expect(() =>
  ...
  describe("changeName method", () => {
    it("should invalidate an category with malformed name property", () => {
